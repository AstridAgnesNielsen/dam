...
# I use two different methods to calculate the average reign duration:
...
# I create a new 'kings_long' data frame that only includes monarchs with above average reign durations. The count function tells us how many of these there are.
...
# I use the slice function to select the highest 3 durations. Note: Christian 9. and Erik af Pommern ruled for the same amount of years, so they're both in third.
